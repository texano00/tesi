...
\begin{figure}[htp]
    \centering  
    \subfloat[Domanda]{\includegraphics[scale=0.3]{img/cap2/chatbot-1}}
    \subfloat[Risposta]{\includegraphics[scale=0.3]{img/cap2/chatbot-2}}
\end{figure}
...
\begin{figure}[htp]
    \centering  
    \subfloat[Brainstorming]{\includegraphics[scale=0.5]{img/cap2/eservant-chatbot}}
\end{figure}
